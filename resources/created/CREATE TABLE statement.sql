...
/*
Whatever inside the parenthesis is called the table definition
Every row inside the parenthesis correspond to the column definition, 
A column definition has datatypes and constraints
*/